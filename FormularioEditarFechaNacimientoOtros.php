...
<body>
	<form name="editarfechanacimiento" method="post" onsubmit="return ValidarDatos()">
		<table align="center">
			...
			<tr>
				<td></td>
				<td><input class="btn btn-primary" type="submit" name="editarfechanacimiento" value="Modificar"><input class="btn btn-default" type="button" name="volver" value="Volver" onclick="location.href='MenuDatosPersonalesOtros.php'"></td>
