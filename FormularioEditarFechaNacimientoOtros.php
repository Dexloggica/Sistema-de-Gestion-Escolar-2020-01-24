...
<html>
<head>
	<title>Editar Fecha de Nacimiento de Otro Usuario</title>
	...
	<h2 align="center">Editar Fecha de Nacimiento de Otro Usuario</h2>
</head>
<body>
	<form name="editarfechanacimiento" method="post" onsubmit="return ValidarDatos()">
		<table align="center">
			...
			<tr>
				<td></td>
				<td><input style="margin: 5px" class="btn btn-primary" type="submit" name="editarfechanacimiento" value="Modificar"><input style="margin: 5px" class="btn btn-default" type="button" name="volver" value="Volver" onclick="location.href='MenuDatosPersonalesOtros.php'"></td>
	...
	<?php
			...
			{
				require("CodigoEditarFechaNacimientoOtro.php");
