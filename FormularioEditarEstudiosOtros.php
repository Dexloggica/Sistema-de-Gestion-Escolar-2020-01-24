...
<html>
<head>
	<title>Editar Estudios de Otros</title>
	...
	<h2 align="center">Editar Estudios de Otros</h2>
</head>
<body>
	<form name="editarestudios" method="post" onsubmit="return ValidarDatos()">
		<table align="center">
			...
			<tr>
				<td></td>
				<td><input style="margin: 5px" class="btn btn-primary" type="submit" name="guardarestudios" value="Modificar"><input style="margin: 5px" class="btn btn-default" type="button" name="volver" value="Volver" onclick="location.href='MenuDatosPersonalesOtros.php'"></td>
...
<?php
	...
	{
		require("buscaridUsuarioEstudios.php");
	}
	
	if(isset($_POST['guardarestudios']))
	{
		require("CodigoEditarEstudiosOtro.php");
