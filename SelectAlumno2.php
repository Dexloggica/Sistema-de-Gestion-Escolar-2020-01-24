...
$consulta= "SELECT * FROM Persona,Inscripcion WHERE Persona.idPersona=Inscripcion.Persona_idPersona"; 
...
// $resultado= mysql_query($consulta,$link) or die (mysql_error());
	   echo"<select style='margin: 5px' class='btn btn-default dropdown-toggle' name='idAlumno'>
