...
echo"<center>";
require("FuncionConexionBasedeDatos.php");
$consulta= "SELECT * FROM Autor WHERE idAutor='$idAutor'"; 
...
////////////////
				...
				for($i=0;$i<count($idLibro);$i++) 
				{
					// if($matriz[13][$i]==$idAutor){
						echo "<tr  align='center'><td>".$matriz[0][$i]."</td>";
					echo "<td>".$matriz[1][$i]."</td>";
					echo "<td>".$matriz[2][$i]."</td>";
					echo "<td>".$matriz[3][$i]."</td>";
					echo "<td>".$matriz[4][$i]."</td>";
					echo "<td>".$matriz[5][$i]."</td>";
								echo"<td><IMG SRC=".$matriz[6][$i]." WIDTH=70 HEIGHT=100 ALT='Imagen'></td>";

								echo"<td><a href=".$matriz[7][$i]." target='_blank'>Descargar pdf</a></td>";
					// echo "<td>".$matriz[6][$i]."</td>";
					// echo "<td>".$matriz[7][$i]."</td>";
					echo "<td>".$matriz[8][$i]."</td>";
					echo "<td>".$matriz[9][$i]."</td>";
					echo "<td>".$matriz[10][$i]."</td>";
