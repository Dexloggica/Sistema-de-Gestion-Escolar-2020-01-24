...
<body>
	<form name="editardomicilio" method="post" onsubmit="return ValidarDatos()">
		<table align="center">
			...
			<tr>
				<td></td>
				<td><input class="btn btn-primary" type="submit" name="guardardomicilio" value="Modificar"><input  class="btn btn-default" type="button" name="volver" value="Volver" onclick="location.href='MenuEditarDatosPersonalesAlumnoaCargo.php'"></td>
