...
<body>
	<form name="editarlocalidad" method="post" onsubmit="return ValidarDatos()">
		<table align="center">
			...
			<tr align="center">
				<td><input class="btn btn-primary" type="submit" name="guardarlocalidad" value="Modificar"><input class="btn btn-default"  type="button" name="volver" value="Volver" onclick="location.href='MenuEditarDatosPersonalesAlumnoaCargo.php'"></td>
