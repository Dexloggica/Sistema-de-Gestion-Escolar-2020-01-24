...
<html>
<head>
	<title>Editar Localidades de Alumno/s a Cargo</title>
	<!--<script>
	...
	<h2 align="center">Editar Localidades de Alumno/s a Cargo</h2>
</head>
<body>
	<form name="editarlocalidad" method="post" onsubmit="return ValidarDatos()">
		<table align="center">
			...
			<tr align="center">
				<td><input style="margin: 5px" class="btn btn-primary" type="submit" name="guardarlocalidad" value="Modificar"><input style="margin: 5px" class="btn btn-default"  type="button" name="volver" value="Volver" onclick="location.href='MenuEditarDatosPersonalesAlumnoaCargo.php'"></td>
	...
	<?php
			...
			if(isset($_POST['buscarid']))
			{
				...
				require("buscaridUsuarioLocalidadAlumnoaCargo.php");
			}
			
			if(isset($_POST['guardarlocalidad']))
			{
				require("CodigoEditarLocalidadAlumnoaCargo.php");
			}
	?>		
</body>
