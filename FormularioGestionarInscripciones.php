...
<html>
	...
	<p align="center"><?php echo "                                           hora: "  . date("H:i:s"); ?></p>
		...
		<table align="center">
			<tr align="center">
				<td><input class="btn btn-default" type="submit" name="volver" value="Volver"><input class="btn btn-primary" type="submit" name="registrarinscripcion" value="Registrar"><input class="btn btn-info" type="submit" name="mostrarinscripciones" value="Mostrar todas las inscripciones"></td>
			</tr>
