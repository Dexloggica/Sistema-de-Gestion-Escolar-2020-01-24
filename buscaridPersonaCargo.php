...
// echo"id buscado=$idbuscado";
	...
	{ 
		...
		echo"Persona no encontrada";
				...
				// mysql_select_db("0612_version5",$conex) or die("ERROR con la base de datos");
				//require("FuncionConexionBasedeDatos.php");
				$query="SELECT * FROM Persona,Cargo,TipoPerfil,CedulaDocente WHERE Persona.idPersona=Cargo.Persona_idPersona and Cargo.TipoCargo=TipoPerfil.idTipoPerfil and CedulaDocente.Persona_idPersona=Persona.idPersona and Persona.idPersona='$idPersona'";
