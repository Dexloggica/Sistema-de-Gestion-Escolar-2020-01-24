...
<html>
<head>
	<title>Editar Idiomas de Otros</title>
	...
	<h2 align="center">Editar Idiomas de Otros</h2>
</head>
<body>
	<form name="editaridiomas" method="post" onsubmit="return ValidarDatos()">
		<table align="center">
			...
			<tr>
				<td></td>
				<td><input style="margin: 5px" class="btn btn-primary"  type="submit" name="guardaridiomas" value="Modificar"><input style="margin: 5px" class="btn btn-default" type="button" name="volver" value="Volver" onclick="location.href='MenuDatosPersonalesOtros.php'"></td>
	...
	<?php
			...
			if(isset($_POST['buscarid']))
			{
				...
				require("buscaridUsuarioIdiomas.php");
			}
			if(isset($_POST['guardaridiomas']))
			{
				require("CodigoEditarIdiomasOtro.php");
			}
	?>		
</body>
